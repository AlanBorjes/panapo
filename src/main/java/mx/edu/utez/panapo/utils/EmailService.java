...
import mx.edu.utez.panapo.user.controller.UserDTO;
...
public class EmailService {
    ...
    public boolean sendEmail (User userDTO){
        try {
            ...
            helper.setSubject("CDS | Nuevo mensaje");
            helper.setText(template(userDTO),true);
            mailSender.send(msg);
            return true;
        }catch (Exception e){
            e.printStackTrace();
    ...
    public String template(User userDTO) {
        ...
        String htmlEmail = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" " +
                ...
                "            <td style=\"padding:30px;background:#153643; width:100%;\">\n" +
